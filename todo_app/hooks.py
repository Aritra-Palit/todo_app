app_name = "todo_app"
app_title = "aritra_todo_list"
app_publisher = "Aritra Palit"
app_description = "A simple to-do list application to manage tasks with priorities and due dates."
app_email = "aritrapalit14@gmail.com"
app_license = "mit"
